...
namespace Doozy.Engine.Soundy
{
    ...
    public class SoundGroupData : ScriptableObject
    {
        ...
        /// <summary> Returns a random priority value between 0f and 1f </summary>
        ...
        // [MinMaxRangeInt(MIN_PRIORITY, MAX_PRIORITY)]
        ...
        public SoundyController Play(Vector3 position, AudioMixerGroup outputAudioMixerGroup = null)
        {
            ...
            controller.SetSourceProperties(m_lastPlayedAudioData.AudioClip, Priority, RandomVolume, RandomPitch, Loop, SpatialBlend);
        ...
        public AudioData GetAudioData(PlayMode playMode)
        {
